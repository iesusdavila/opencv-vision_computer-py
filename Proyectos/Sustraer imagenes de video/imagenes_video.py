...
while True:
    ...
    for (x,y,w,h) in faces:
        i=i+1
        cv2.putText(frame, "Persona "+str(i), (x,y), cv2.FONT_HERSHEY_COMPLEX, 1.2, (0,255,0), thickness=3)
        cv2.rectangle(frame, (x,y),(x+w,y+h),(0,255,0),2)
    
    cv2.putText(frame, "Personas encontradas "+str(i), (20,20), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0,255,0), thickness=3)
